...
bech32_templates = [
  ...
  ('afc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('afc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('afc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tafc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tafc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tafc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rafc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rafc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rafc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tafc',  17, 32, False, False, False),
  ('rafc',  3,  1, False, False, False),
  ('afc',   15, 41, False, False, False),
  ('tafc',  0, 16, False, False, False),
  ('rafc',  0, 32, True,  False, False),
  ('afc',   0, 16, True,  False, False),
  ('tafc',  0, 32, False, True,  False),
  ('rafc',  0, 20, False, False, True)
]
