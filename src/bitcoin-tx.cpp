...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " africoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  africoin-tx [options] <hex-tx> [commands]  Update hex-encoded africoin transaction\n" +
            "or:     africoin-tx [options] -create [commands]   Create hex-encoded africoin transaction\n" +
            "\n";
