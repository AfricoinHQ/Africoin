# Support for Output Descriptors in Africoin Core

Since Africoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `afc1...` for mainnet or `tafc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Africoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Africoin Core wallets, a convenience function `combo` is
