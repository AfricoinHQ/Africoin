Africoin Core version *0.15.1* is now available from:

  <https://download.africoin.org/africoin-0.15.1/>
...
A number of changes to the way Africoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 eco per kB (0.00001 AFC). This is to prepare for dropping the minimum transaction fee to 0.1 eco per kB (0.0001 AFC) in the next release.
