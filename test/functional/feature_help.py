...
"""Verify that starting africoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start africoin with -h for help text")
        ...
        self.log.info("Start africoin with -version for version information")
        ...
        self.log.info("Start africoind with -fakearg to make sure it does not start")
